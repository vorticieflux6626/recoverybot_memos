...
class MixedPrecisionEmbeddingService:
    ...
    def __init__(
        ...
        # Quantization metadata
        self.quant_metadata: Dict[str, Dict] = {}     # doc_id -> {scale, zero_point}
        ...
        logger.info(
            ...
            f"model={embedding_model}, dim={default_dimension}"
        )
        ...
        try:
            async with httpx.AsyncClient(timeout=60.0) as client:
                ...
                if response.status_code == 200:
                    ...
                    return np.zeros(self.default_dimension, dtype=np.float16)
