...
async def store_memory(
    ...
    try:
        ...
        stored_memory = await memory_service.store_memory(
            ...
            privacy_level=MemoryPrivacyLevel(memory_data.privacy_level),
        ...
        memory_logger.log_memory_created(
            user_id=memory_data.user_id,
...
async def search_memories(
    ...
    try:
        ...
        memory_logger.log_memory_retrieved(
            user_id=user_id,
            query=query,
...
async def list_user_memories(
    ...
    try:
        ...
        memories = await memory_service.get_user_memories(
            ...
            privacy_level=MemoryPrivacyLevel(privacy_level) if privacy_level else None,
        ...
        total_count = await memory_service.get_user_memory_count(
            user_id=user_id,
            memory_type=MemoryType(memory_type) if memory_type else None,
            privacy_level=MemoryPrivacyLevel(privacy_level) if privacy_level else None,
            recovery_stage=recovery_stage
